...
void VolWidget::init()
{
    ...
    m_btnIcon->setStyleSheet("QPushButton{border-image:url(:/image/music/btn_volume_on.png);}\
                             QPushButton:pressed\
                             {\
...
void VolWidget::updateIconBySliderValue(int value)
{
    if(value == 0){
        isMute = true;
        m_btnIcon->setStyleSheet("QPushButton{border-image:url(:/image/music/btn_volume_off.png);}\
                                 QPushButton:pressed\
                                 {\
                                     background-color:rgb(204 , 228 , 247);\
                                     border: 1px solid rgb(1 , 84 , 153);\
